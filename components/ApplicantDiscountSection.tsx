...
export default function ApplicantDiscountSection() {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-[#FFF8F0] rounded-2xl shadow-2xl max-w-6xl mx-auto my-12 border border-[#B21D00]">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-10 text-center text-[#B21D00] flex flex-col sm:flex-row items-center justify-center gap-2">
