...
export default function ApplicantDiscountSection() {
  ...
  return (
    <section className="py-16 px-6 bg-white text-gray-900 rounded-2xl shadow-xl max-w-5xl mx-auto my-12 border border-green-200">
      <h2 className="text-3xl md:text-4xl font-extrabold mb-10 text-center text-green-700 flex items-center justify-center gap-2">
  ...
  <img src="https://placehold.co/150x50?text=Brand+3" alt="Affiliate 3" className="h-12" />
        ...
        <div className="p-6 rounded-xl bg-green-50 border border-green-300 shadow-md">
          <p className="font-semibold text-lg mb-2 text-green-800 flex items-center gap-2">
          ...
          <p className="mt-4 text-lg font-medium text-gray-800">
            ...
            <span className="text-green-700 font-bold">₹{price - discount}</span>
          </p>
          ...
          <div className="text-center mt-6">
            ...
            {message && (
              <p className="mt-4 text-green-700 font-semibold flex items-center gap-2 justify-center">
                {message.includes("⚠️") ? (
